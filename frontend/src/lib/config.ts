...
// Deployed on GIWA Sepolia (chainId 91342). Real DojangVerifier → live DojangScroll.
// Baked in so the hosted site works with no config. Override via VITE_* only if you redeploy.
